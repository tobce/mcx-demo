...
function generateDummyFolkeregister() {
    ...
    folkeregister.leggTilPerson(new Person('05050556789', '2002-05-05', 'Berg', 'August', '96789012'));
    folkeregister.leggTilPerson(new Person('00000000000', '2004-05-05', 'Haug', 'Sarah', '96789012'));
